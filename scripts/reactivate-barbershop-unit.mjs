/**
 * Reativa unidade arquivada.
 * Uso: node scripts/reactivate-barbershop-unit.mjs adm ADM2
 */
...
if (!slug || !unitName) {
  console.error("Uso: node scripts/reactivate-barbershop-unit.mjs <slug> <nome-unidade>")
  process.exit(1)
}
...
console.log(`OK: unidade "${unitName}" reativada em /b/${slug} (id=${unit.id})`)
