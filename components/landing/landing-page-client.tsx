...
<div className="flex flex-col gap-2 pt-4 border-t border-border">
      ...
      {/* Hero Section */}
      <section className="pt-32 sm:pt-36 md:pt-44 pb-16 sm:pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="flex-1 text-center lg:text-left">
              ...
              <div className="flex flex-col gap-2.5 sm:gap-3 justify-center lg:justify-start max-w-md mx-auto lg:mx-0 w-full">
                <Link href="/cadastro?tipo=barbearia" className="w-full">
                  <Button
                    type="button"
                    className={`w-full h-auto min-h-[2.875rem] sm:min-h-[3.25rem] py-3 sm:py-3.5 px-4 sm:px-5 rounded-xl font-bold flex items-center justify-center gap-2.5 sm:gap-3 ${landingGoldBtnClass}`}
                  >
                    <Sparkles className="w-4 h-4 sm:w-5 sm:h-5 shrink-0" />
                    <span className="flex flex-col items-start text-left leading-tight">
                      <span className="text-sm sm:text-lg">Comece agora</span>
                      <span className="text-[11px] sm:text-sm font-normal opacity-90">
                        {TRIAL_OFFER_HEADLINE}
                      </span>
                    </span>
                  </Button>
                ...
                <Button
                  asChild
                  className={[
                    "hidden sm:flex w-full h-auto min-h-[3.25rem] py-3.5 px-5 rounded-xl font-semibold",
                ...
                {whatsappUrl ? (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="sm:hidden text-center text-sm text-primary hover:underline py-1"
                  >
              ...
              <div className="flex items-center gap-6 sm:gap-8 mt-8 sm:mt-10 justify-center lg:justify-start">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-sm text-muted-foreground">
              Depoimentos ilustrativos — substitua por avaliações reais quando disponíveis.
            </p>
          </div>
