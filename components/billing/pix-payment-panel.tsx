      ...
      <div className="flex items-start gap-3">
        ...
        <div className="space-y-1 min-w-0">
          ...
          <p className="text-sm text-muted-foreground">
            ...
            . Escaneie o QR ou copie o código. O plano ativa após a confirmação do pagamento.
          </p>
          <p className="text-xs text-muted-foreground">
            Todo mês você receberá um novo PIX para pagar a mensalidade (o Asaas pode avisar por e-mail).
          </p>
        </div>
      </div>
